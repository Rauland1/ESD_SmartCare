...
public class ApproveRegistrationServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(request.getParameter("approve_reg") != null)
        {
            dbcon.confirmReg(request.getParameter("regUsername"));
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ApproveRegistrationServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
