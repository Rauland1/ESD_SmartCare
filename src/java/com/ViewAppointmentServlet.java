...
public class ViewAppointmentServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        else if(request.getParameter("view_appointments").equals("true") )
        {
            
            String appointmentRows = dbcon.viewAppointments(user.getId());
            
            request.setAttribute("aRow", appointmentRows);
